                    ...
                    <div className="col-lg-4">
                        <div className="card mb-3">
                            <div className="card-body text-center shadow "><img className="rounded-circle mb-3 mt-4"
                                                                               src="assets/img/avatars/Fotor_AI%20(1).png"
                                                                               width="160" height="160"
                                                                               />
                                <div className="mb-3">
                                    <button className="btn btn-primary btn-sm" type="button"
                                            style={{background: "var(--bs-dark)"}}>Change Photo
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card-body">
                                ...
                                <div className="progress progress-sm mb-3">
                                    <div className="progress-bar bg-danger" aria-valuenow="20" aria-valuemin="0"
                                        ...
                                        className="visually-hidden">20%</span></div>
                                </div>
                                ...
                                <div className="progress progress-sm mb-3">
                                    <div className="progress-bar bg-warning" aria-valuenow="40" aria-valuemin="0"
                                        ...
                                        className="visually-hidden">40%</span></div>
                                </div>
                                ...
                                <div className="progress progress-sm mb-3">
                                    <div className="progress-bar bg-info" aria-valuenow="80" aria-valuemin="0"
                                        ...
                                        className="visually-hidden">80%</span></div>
                                </div>
                                ...
                                <div className="progress progress-sm mb-3">
                                    <div className="progress-bar bg-success" aria-valuenow="100" aria-valuemin="0"
                                        ...
                                        className="visually-hidden">100%</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-8">
                                ...
                                <div className="card text-white bg-primary shadow">
                                    <div className="card-body">
                                        ...
                                        <p className="text-white-50 small m-0"><i
                                            className="fas fa-arrow-up"></i>&nbsp;5% since last month</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col">
                        ...
                        <div className="row">
                            <div className="col">
                                    ...
                                    <div className="card-body">
                                        <form>
                                            <div className="row">
                                                <div className="col">
                                                    <div className="mb-3"><label className="form-label"
                                                                                 htmlFor="username"><strong>Username</strong></label><input
                                                        className="form-control" type="text" id="username"
                                                        placeholder="user.name" name="username"/></div>
                                                </div>
                                                <div className="col">
                                                    <div className="mb-3"><label className="form-label" htmlFor="email"><strong>Email
                                            ...
                                            <div className="row">
                                                <div className="col">
                                                    <div className="mb-3"><label className="form-label"
                                                                                 htmlFor="first_name"><strong>First
                                            ...
                                            <div className="mb-3">
                                                <button className="btn btn-primary btn-sm" type="submit"
                                                        style={{background: "var(--bs-dark)"}}>Save Settings
                                                </button>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                {/*        <form>*/}
                                {/*            <div className="mb-3"><label className="form-label"*/}
                                {/*                                         htmlFor="address"><strong>Address</strong></label><input*/}
                                {/*                className="form-control" type="text" id="address"*/}
                                {/*                placeholder="Sunset Blvd, 38" name="address"/></div>*/}
                                {/*            <div className="row">*/}
                                {/*                <div className="col">*/}
                                {/*                    <div className="mb-3"><label className="form-label"*/}
                                {/*                                                 htmlFor="city"><strong>City</strong></label><input*/}
                                {/*                        className="form-control" type="text" id="city"*/}
                                {/*                        placeholder="Los Angeles" name="city"/></div>*/}
                                {/*                </div>*/}
                                {/*                <div className="col">*/}
                                {/*                    <div className="mb-3"><label className="form-label"*/}
                                {/*                                                 htmlFor="country"><strong>Country</strong></label><input*/}
                                {/*                        className="form-control" type="text" id="country"*/}
                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="col-md-6">
                                <form>
                                    <div className="mb-3"><label className="form-label"
                                                                 htmlFor="signature"><strong>Signature</strong><br/></label><textarea
                                        className="form-control" id="signature" rows="4" name="signature"></textarea>
                                    </div>
                                    <div className="mb-3">
                                        <div className="form-check form-switch"><input className="form-check-input"
                                                                                       type="checkbox" id="formCheck-1"/><label
                                            className="form-check-label" htmlFor="formCheck-1"><strong>Notify me about
                                            new replies</strong></label></div>
                                    </div>
                                    <div className="mb-3">
                                        <button className="btn btn-primary btn-sm" type="submit"
                                                style={{background: "var(--bs-dark)"}}>Save Settings
